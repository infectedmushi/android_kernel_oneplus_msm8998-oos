...
export LOCALVERSION=~infected-blu-r1-oos-pie-$(date +%y%m%d)-$HASH
export ARCH=arm64
...
zip -r9 infected-blu-r1-oos-pie-op5t-$(date +%y%m%d)-$HASH.zip *
mv -v infected-blu-r1-oos-pie-op5t-*.zip /mnt/Building/Out_Zips
echo "Done!!!"
